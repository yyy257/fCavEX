...
// Place still water into the placement cell, then swap back to empty bucket.
// Return false so the engine will NOT consume the item additionally.
...
struct item item_bucket_water = {
	...
	.onItemPlace = onItemPlace, //onItemPlace,
